...
const Login = () => {
  ...
  const onExpand = useCallback(() => setExpanded(current => (current === "login" ? "password" : "login")), [setExpanded]);
              ...
              <AccordionDetails>
                <Box py={3}>
                  <Grid container spacing={2}>
                    ...
                    <Grid item xs={12}>
                      <TextInput label="Senha" type="password" fullWidth value={values.pass} onChange={onChange("pass")} />
                    </Grid>
